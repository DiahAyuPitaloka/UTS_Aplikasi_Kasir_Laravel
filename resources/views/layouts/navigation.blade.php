<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @auth
                    ...
                    @if (Auth::user()->isAdmin())
                        <!-- ADMIN: Tautan Dashboard (Ringkasan Admin) -->
                        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @endif
                    
                    <!-- Tautan Transaksi Baru (Muncul untuk Admin dan Kasir) -->
                    <x-nav-link :href="route('sales.create')" :active="request()->routeIs('sales.create')">
                        {{ __('Transaksi Baru') }}
                    </x-nav-link>

                    @if (Auth::user()->isAdmin()) 
                        <!-- Tautan Admin Lainnya -->
            ...
            <!-- Bagian Dropdown Settings (Tidak diubah) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <!-- Tautan Transaksi Baru (Hanya ini yang tersisa untuk Kasir) -->
